    ...
    return Column(
      children: [
        ...
        Text(
          ...
          "К примеру, можно настроить, чтобы в школе показывалось расписание, а дома будут показаны задания.\n\n"
          "Также есть функция, которая автоматически открывает экран добавления задания сразу при запуске приложения в школьное время, чтобы быстро добавить задание сразу после урока.",
